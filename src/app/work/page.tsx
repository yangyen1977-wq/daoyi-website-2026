...
export const metadata: Metadata = {
  title: "案例證據",
  description: "道易科技 2026 案例證據系統，不把案例當作品集，而是當成能支撐 shortlist、採購與提案決策的證據系統。",
...
export default function WorkPage() {
  return (
    <main id="main-content">
      ...
      <Section eyebrow="Case structure" title="案例採用 challenge / delivery / outcome 的重述方式。">
        <CaseOverviewStats />
      </Section>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "CollectionPage", name: "DaoYi work system", url: `${siteConfig.url}/work` }) }}
      />
    </main>
  );
}
