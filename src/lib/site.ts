export const siteConfig = {
  ...
  heroTitle: "把品牌官網、案例證據、AI / 資料流程，整成決策者一看就懂也願意開始的 B2B 系統",
  heroDescription:
    "給 B2B 品牌、製造業與研究型組織：道易把品牌主張、案例證據、AI 導入、知識平台與 DPP / Traceability 收斂成同一套可交付方案，讓決策者更快 shortlist、讓內部更快對齊，也讓第一次接洽更容易放心開始。",
};
...
export const contactHeroChecklist = [
  {
    label: "先給什麼",
    title: "舊站或現有系統連結",
    detail: "只要能看到目前長什麼樣，道易就能更快指出 hero、案例、CTA 或資料流程的阻力點。",
  },
  {
    label: "再補什麼",
    title: "這次要說服的角色",
    detail: "例如品牌主管、採購、法遵、永續或內部 IT，能幫助我們把第一次會議對得更準。",
  },
  {
    label: "最後說明",
    title: "時程與敏感條件",
    detail: "若有 NDA、招標節點、法規時程或既有供應商限制，第一封信就能先處理。",
  },
];
...
export const homepageHeuristicScorecard = [
  {
