...
export const solutionDetails = [
  {
    ...
    audience: ["ESG、碳盤查、回收履歷或供應鏈透明團隊", "已有資料平台，但稽核證據不足的組織"],
    problems: ["資料散在 Excel、表單、設備或不同系統", "稽核時缺少來源、版本、時間與修改紀錄"],
    approach: "盤點資料來源與稽核節點，定義證據模型、驗證流程與查核介面。",
    deliverables: ["資料來源與信任缺口盤點", "證據模型與流程圖", "Dashboard / API 查核原型"],
    cta: "我想盤點資料信任鏈",
  },
  {
    ...
    audience: ["製造品牌、出口企業、材料供應商", "想先做 DPP、QR 查詢或產品履歷 PoC 的團隊"],
    problems: ["產品資料分散在部門、供應商與文件中", "有查詢頁需求，但後台欄位與維護流程未定義"],
  ...
  },
  {
    ...
    problems: ["資料量大，但使用者找不到真正需要的內容", "人物、作品、事件與地點關係難以查詢與呈現"],
    approach: "用 Ontology 定義核心實體、關係與查詢場景，再串接語意擷取、搜尋與後台治理流程。",
  ...
  },
  {
    ...
    problems: ["現場作業資料與管理系統斷裂", "流程缺少批次、來源、時間與狀態追蹤"],
    approach: "整理現場流程與資料節點，規劃 AIoT 串接、影像辨識、異常校驗與 Dashboard。",
    deliverables: ["現場資料流程圖", "履歷欄位設計", "AIoT / Dashboard 原型"],
    cta: "我想規劃回收履歷整合",
  },
];
